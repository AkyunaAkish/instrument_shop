...
// Usage:
// <CustomSnackBar snackbarOpen={ this.state.connectionSnackbarOpen } 
//                 snackbarVariant={ this.state.connectionSnackbarVariant }
//                 snackbarContent={ this.state.connectionSnackbarContent }
